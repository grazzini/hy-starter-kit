...
We'll see the Kyrie is organized and how Josquin derives the subjects
...
from last year. ([Presentation](https://tinyurl.com/yaal5r2x))
...
Today we'll discuss the Modes, which are not exactly what you might expect, if
...
and polyphonic compositions. Then we'll look at the Kyrie from another great 
Josquin mass.
